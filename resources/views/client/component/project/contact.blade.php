<div class="grid grid-cols-2 p-6 bg-gray-100 mt-12">
    ...
    <div class="flex items-center justify-center text-center mb-8">
        <div>
            ...
            <p class="text-lg font-bold mt-2">+62 818-0734-0561</p>
            <a href="https://wa.me/6281807340561" class="inline-block bg-green-500 text-white px-6 py-2 rounded-full mt-4 shadow-md hover:bg-green-600 transition">Chat Now</a>
        </div>
    </div>
